...
use PHPMailer\PHPMailer\PHPMailer;
   ...
   $this->load->view('include/vendor/autoload.php');
		...
		$mail->Subject = "GYM - Payment Invoice";
 ...
 <h1 style='padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px'>GYM - Payment <span class='il'>Invoice</span></h1>
 </td>
 </tr>
 </tbody>
 </table>

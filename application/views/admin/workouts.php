                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Workout Details Added </h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ml-auto">
                                  <a href="<?php echo base_url()."add_workout"; ?>" class="badge badge-danger" style="float:right;">Add Workouts</a>
                                </div>
                            </div>
                            <p>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><?php echo ++$key; ?></td>
                                        <td class="centr"><?php echo $value->workout_name; ?></td>
                                        <td class="centr"><a href="<?php echo base_url()."edit_workout/".$value->workout_id; ?>">Edit</a></td>
                                    </tr>
                                  <?php  } ?>
                                </tbody>
                            </table>

                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Send Mail Sperately</h3>
                            ...
                            <form method="post" action="<?php echo base_url()."send_sep_mail"; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="user_id">
                                        ...
                                        <<?php foreach ($user_data as $key => $value): ?>
                                            <option value="<?php echo $value->gym_mem_id; ?>"><?php echo $value->gym_mem_id_2."-".$value->email_id; ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                   <center><input type="submit" name="" value="Send Mail" class="btn btn-primary"></center>
                                </div>
                            </div>
                        </form>
                        </div>

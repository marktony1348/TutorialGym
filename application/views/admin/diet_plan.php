            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Deit Plan</h4>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Deit Details Added </h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ml-auto">
                                  <a href="<?php echo base_url()."add_deit"; ?>" class="badge badge-danger" style="float:right;">Add Deit</a>
                                </div>
                            </div>
                            <p>
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        <th>Sl. No.</th>
                                        <th class="centr">workout_name</th>
                                        <th class="centr">min / max height</th>
                                        <th class="centr">min / max weight</th>
                                        <th class="centr">Foods</th>
                                        <th class="centr">Edit</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><?php echo ++$key; ?></td>
                                        <td class="centr"><?php echo get_data_value('tbl_diet_plan_name','plan_id',$value->workout_id,'plan_name'); ?></td>
                                        <td class="centr"><?php echo $value->min_height." / ".$value->max_height; ?></td>
                                        <td class="centr"><?php echo $value->min_weight." / ".$value->max_weight; ?></td>
                                        <td class="centr"><?php echo $value->foods_m; ?></td>
                                        <td class="centr"><a href="<?php echo base_url()."edit_diet/".$value->diet_id; ?>">Edit</a></td>
                                    </tr>
                                  <?php  } ?>
                                </tbody>
                            </table>

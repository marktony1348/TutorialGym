            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Chat Details</h4>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Chat Details </h3>
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        <th>Sl. No.</th>
                                        <th class="centr">client_msg</th>
                                        <th class="centr">date_of_msg</th><th class="centr">reply</th>
                                        <th class="centr">date_of_reply</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><?php echo ++$key; ?></td>
                                        <td class="centr"><?php echo $value->client_msg; ?></td>
                                        <td class="centr"><?php echo $value->date_of_msg; ?></td>
                                        <td class="centr"><?php echo $value->reply; ?></td>
                                        <td class="centr"><?php echo $value->date_of_reply; ?></td>
                                        <?php if($value->reply !=''){ echo"<td></td>"; }else{ ?>
                                        <td class="centr"><a href="<?php echo base_url()."reply_msg/".$value->msg_id; ?>">Reply</a></td>
                                    <?php   }  ?>
                                    </tr>
                                  <?php   }  ?>
                                </tbody>

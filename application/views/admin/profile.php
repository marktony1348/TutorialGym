...
<?php $this->load->view('include/sidebar'); ?>
                        ...
                        <div class="white-box">
                            ...
                            <div class="collapse border box_shawow" id="collapseExample">
                              <div class="card card-body">
                                <form class="form-horizontal form-con"  method="post" action="<?php echo  base_url()?>update_profile" enctype="multipart/form-data">
  ...
  <label for="photo" class="btn1 btn1-large">Select file</label>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-5">
                                        <input name="name" type="text" placeholder="NAME" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->name))
                                    { ?> value="<?php echo $admin_profile[0]->name; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                        <textarea class="form-control" name="address" placeholder="GYM Address" required><?php if(!empty($admin_profile) && !empty($admin_profile[0]->address))
                                    { echo $admin_profile[0]->address; } ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                         <input name="gym_land_mark" type="text" placeholder="GYM Landmark" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->gym_land_mark))
                                    { ?> value="<?php echo $admin_profile[0]->gym_land_mark; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                         <input name="gym_location" type="text" placeholder="GYM location" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->gym_location))
                                    { ?> value="<?php echo $admin_profile[0]->gym_location; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-5">
                                         <input name="tw" type="text" placeholder="twitter link" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->tw))
                                    { ?> value="<?php echo $admin_profile[0]->tw; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-5">
                                         <input name="yt" type="text" placeholder="Youtube link" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->yt))
                                    { ?> value="<?php echo $admin_profile[0]->yt; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                         <input name="mobile" type="text" placeholder="Mobile Number" class="form-control" required <?php if(!empty($admin_profile) && !empty($admin_profile[0]->mobile))
                                    { ?> value="<?php echo $admin_profile[0]->mobile; ?>" <?php } ?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                      <div class="col-md-5">
        ...
        { ?> UPDATE <?php }else{ echo"ADD"; } ?></button>
                                    ...
                                    <input type="hidden" name="edit_or_not" value="<?php if(!empty($admin_profile))
        { ?>YES<?php }else{ ?>No<?php } ?>">
                                    </fieldset>
                                    </form>
                              </div>

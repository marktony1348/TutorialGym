                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <form method="post" action="<?php echo base_url()."workout_update"; ?>">
                            <?php }else{ ?>
                                <form method="post" action="<?php echo base_url()."workout_add"; ?>">
                            <?php } ?>
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Add Workout Details</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="workout_name" class="form-control" required <?php if(!empty($workout_data) && $workout_data[0]->workout_name){ echo"value='".$workout_data[0]->workout_name."'"; } ?>>
                                </div>
                            </div>
                            <br>
                            <?php 
                            if(!empty($workout_data)){
                            $get_links = explode(",",$workout_data[0]->video_links);
                            foreach ($get_links as $key => $value) {
                               ?>
                            <div class='row'>
                                <div class='col-md-2'>
                                    <input type='text' class='form-control' name='day[]' readonly value='Day - <?php echo ++$key; ?>'>
                                </div>
                                <div class='col-md-10'>
                                    <input type='text' class='form-control' name='links[]' placeholder='Paste Your Link here' value="<?php echo $value; ?>">
                                </div>
                            </div><br>
                            <?php } } ?>
                            
                            <span class="badge badge-info add_row">Add Row</span>
                            <span class="badge badge-info count_row"><?php if(!empty($get_links)){ echo count($get_links); }else{ echo"0"; } ?></span>
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                        <input type="hidden" name="workout_id" <?php if(!empty($workout_data)) {?>value="<?php echo $workout_data[0]->workout_id; ?>" <?php } ?> >
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.add_row').click(function(){
            ...
            $('.add_row').before("<div class='row'><div class='col-md-2'><input type='text' class='form-control' name='day[]' readonly value='Day - "+count_row+"'></div><div class='col-md-10'><input type='text' class='form-control' name='links[]' placeholder='Paste Your Link here'></div></div><br>");
        });

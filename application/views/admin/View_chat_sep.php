            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Chat Reply Box</h4>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                                <form method="post" action="<?php echo base_url()."msg_update"; ?>">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Chat Reply</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" readonly name="client_msg"><?php if(!empty($message)){ echo$message[0]->client_msg; } ?></textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" required name="reply"><?php if(!empty($message)){ echo$message[0]->reply; } ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="radio" name="common_reply" value="YES"> Common Reply for All Same Questions &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="common_reply" value="NO" checked> Sperate Reply for this only one Message
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                        <input type="hidden" name="msg_id" <?php if(!empty($message)) {?>value="<?php echo $message[0]->msg_id; ?>" <?php } ?> >
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.add_row').click(function(){
            ...
            $('.add_row').before("<div class='row'><div class='col-md-2'><input type='text' class='form-control' name='day[]' readonly value='Day - "+count_row+"'></div><div class='col-md-10'><input type='text' class='form-control' name='foods[]' placeholder='Enter Food details here'></div></div><br>");
        });

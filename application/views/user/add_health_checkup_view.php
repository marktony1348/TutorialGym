                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">View Health Checkup</h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Height</label>
                                    <input type="text" name="height" class="form-control"  readonly <?php if(!empty($health_data)){ echo"value='".$health_data[0]->height."'"; } ?>>
                                </div>
                                <div class="col-md-3">
                                    <label>Weight</label>
                                    <input type="text" name="weight" class="form-control"  readonly <?php if(!empty($health_data)){ echo"value='".$health_data[0]->weight."'"; } ?>>
                                </div>
                                <div class="col-md-3">
                                    <label>Chest</label>
                                    <input type="text" name="chest_size" class="form-control"  readonly <?php if(!empty($health_data)){ echo"value='".$health_data[0]->chest_size."'"; } ?>>
                                </div>
                                <div class="col-md-3">
                                    <label>Select Diet Plan</label>
                                   <input type="text" name="" class="form-control"  readonly <?php if(!empty($health_data)){ echo"value='".get_data_value('tbl_diet_plan_name','plan_id',$health_data[0]->plan_id,'plan_name')."'"; } ?>>
                                </div>
                                </div>
                                <br>
                            <br>
                            
                                 <h5>Food Details <span class="text-danger font-weight-bold">(This recommented by you trainner please follow the day wise below)</span></h5>
                                <?php 
                            if(!empty($foods)){
                                foreach ($foods as $key => $value1) {
                                    ?>
                                    <h5>Combination <?php echo ++$key; ?></h5>
                                    <?php
                            $get_foods_m = explode(",",$value1->foods_m);
                            $get_foods_an = explode(",",$value1->foods_an);
                            $get_foods_e = explode(",",$value1->foods_e);
                            $get_foods_n = explode(",",$value1->foods_n);

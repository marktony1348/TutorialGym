        ...
        { ?> <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>payment"> <i class="fas fa-plus-square"></i> Back</a> <?php }else{ ?><button class="btn btn-primary float-right" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> <i class="fas fa-plus-square"></i>  
                            ...
                            <div class="collapse border box_shawow" id="collapseExample">
                              <div class="card card-body">
                                <form class="form-horizontal form-con"  method="post" action="<?php echo  base_url()?>add_tickets" enctype="multipart/form-data">
                                    <fieldset>
                                      <div class="form-group">
                                      <div class="col-md-5">
                                        
                                        <select name="ticket_issue" id="ticket_issue" class="form-control input-md" required>
                                          <option value="">Select Issues</option>
                                          <?php
                                          foreach ($ticket_issues as $key => $value) {
                                           ?>
                                           <option value="<?php echo $value->ticket_issues_id; ?>"><?php echo $value->issues_name; ?></option>
                                          <?php
                                          }
                                          ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-5">
                                        <textarea class="form-control  input-md" name="ticket_comment" required placeholder="E.g : my payment not reflacted in my account"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-4">
                                        <button id="submit" name="submit" class="btn btn-primary"><i class="fas fa-check"></i> Add</button>
                                      </div>
                                    </div>
                                    </fieldset>
                                    </form>

...
<?php $this->load->view('include/sidebar'); ?>
        ...
        { ?> Edit Payment <?php }else{ echo"Health Check Up View"; } ?> </h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ml-auto">
                                    <a href="<?php echo base_url()."add_health_checkup"; ?>" class="badge badge-danger" style="float:right;">Add New</a>
                                </div>
                            </div>
                            <p>
        ...
        { ?> <?php }else{  ?>
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        <th>Sl. No.</th>
                                        <th class="centr">Diet Plan</th>
                                        <th class="centr">Height</th>
                                        <th class="centr">Weight</th>
                                        <th class="centr">Chest</th>
                                        <th class="centr">date</th>
                                        <th class="centr">View Diet Foods</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><?php echo ++$key; ?></td>
                                        <td class="centr"><?php echo get_data_value('tbl_diet_plan_name','plan_id',$value->plan_id,'plan_name'); ?></td>
                                        <td class="centr"><?php echo $value->height; ?></td>
                                        <td class="centr"><?php echo $value->weight; ?></td>
                                        <td class="centr"><?php echo $value->chest_size; ?></td>
                                        <td class="centr"><?php echo $value->date; ?></td>
                                        <td class="centr"><a href="<?php echo base_url()."view_foods/".$value->mem_diet_id; ?>" class="badge badge-danger">View Diet Food</a></td>
                                    </tr>
                                  <?php  } ?>
                                </tbody>
                            </table>
